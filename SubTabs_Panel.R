subtab1 <- tabPanel("Build a Baseline Life History Scenario",
                    sidebarLayout(
                      ...
                      sidebarPanel(
                        ...
                        shinyjs::hidden(div(id = "base_name",
                                            hr(),
                                            h4("Define Species"),
                                            br(),
...
subtab2 <- tabPanel("Build a Stressor Scenario",
                    sidebarLayout(
                      sidebarPanel(
                        shinyjs::hidden(div(id = "HideAddStressorScenarioButton",
...
subtab5 <- tabPanel("Delete Scenario",
                    sidebarLayout(
                      sidebarPanel(
                        shinyjs::hidden(div(id = "HideDeleteScenarioSelection",
...
subtab42 <- tabPanel("Export Results",
                     sidebarLayout(
                       sidebarPanel(
                         shinyjs::hidden(div(id = "HideSelectionRunID",
                                             h4("Select run ID"),
...
subtab43 <- tabPanel("Import Results",
                     sidebarLayout(
                       sidebarPanel(
                         ...
                         shinyjs::hidden(div(id = "UploadResultsButton",
...
subtab44 <- tabPanel("Delete Results",
                     sidebarLayout(
                       sidebarPanel(
                         shinyjs::hidden(div(id = "HideSelectionResultsRunId",
                                             h4("Select run ID"),
