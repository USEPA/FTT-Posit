...
export_results_markdown_button <-
  actionButton(
    inputId = "export_results_markdown_modal",
    label = "PDF",
    class = "actButtonD1",
    icon = icon("download")
  )

dRMD_button <- downloadButton(
...
#   title = "Results",
#   trigger = "export_results_markdown_modal",
#   size = "large",
